...
threeByThree zeroZero oneZero twoZero zeroOne oneOne twoOne zeroTwo oneTwo twoTwo =
    ThreeByThree
        { zeroZero = zeroZero
        , zeroOne = zeroOne
        , zeroTwo = zeroTwo
